...
![](/img/blog/2016/20160417234413790.jpg)![点击并拖拽以移动](data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw==)
...
具体可以参考：<http://www.cnblogs.com/ghj1976/p/5199086.html>，里面介绍的很详细，这里就不在介绍。
...
x轴方向不变，y轴为负且缩放一半。如果大家看过我之前的[Android Paint之ColorFilter详解](http://blog.csdn.net/abcdef314159/article/details/51751331)，是不是可以参照做一个倒影的效果，这个就不在演示。上面说到在matrix的set方法会把之前的矩阵清除，也就是先变为单位矩阵在set，我们结合代码来看一下
...
![](/img/blog/2016/20160417234413790.jpg)结果和我们计算的基本一致。
...
![](/img/blog/2016/20160417234413790.jpg)我们再来看一下setScale(0.4f, .3f)和preTranslate(600, 600)的结果，pre开头的是前乘，M' = M * T(dx, dy) ，即之前矩阵在前，我们看一下
...
![](/img/blog/2016/20160417234413790.jpg)在修改
